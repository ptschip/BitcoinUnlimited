...
public:
    ...
    void CreateNewBlock(std::shared_ptr<CBlockTemplate> &pTemplate, const CScript &scriptPubKeyIn);
...
private:
    ...
    void CreateNewBlock(std::shared_ptr<CBlockTemplate> &pblocktemplate, const CScript &scriptPubKeyIn, bool blockstreamCoreCompatible);
